...
The script verifies that each image referenced in the annotation file. If an image file is missing, its associated captions are discarded. This step ensures alignment between the text and the visual data, avoiding runtime errors and misaligned training samples.
